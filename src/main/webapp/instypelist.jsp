        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加商品类型','instypeinsert.jsp')"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body layui-table-body layui-table-main">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                <a class="layui-btn" href="instypeToInstrument.do?id=<%=instype.getId()%>">查看</a>
                            </td>

                            <td class="td-manage">

                                <a title="编辑" href="javascript:;" onclick="xadmin.open('编辑','instypeModifyPage.do?id=<%=instype.getId()%>','800','510','1')"
                                   class="ml-5" style="text-decoration:none">
                                    <i class="layui-icon">&#xe642;</i>
                                </a>

                                <a title="删除" href="instypeDelete.do?id=<%=instype.getId()%>" onclick="member_del(this,'1')"
