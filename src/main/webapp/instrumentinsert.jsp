...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" action="instrumentInsert.do" method="post" enctype="multipart/form-data">
            <div class="layui-form-item">
                <label for="name" class="layui-form-label">
                    <span class="x-red">*</span>乐器名
                </label>
                <div class="layui-input-inline">
                    <input type="text" id="name" name="name" placeholder="输入乐器名（必填）" required="" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="price" name="price" placeholder="输入价格（必填）" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="stock" name="stock" placeholder="输入库存（必填）" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="brand" name="brand" placeholder="输入品牌（必填）" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
