...
<body>
    ...
    <form action="instrumentModify.do" method="post">
        ...
        <input type="text" name="instype.id" hidden="hidden" value="${instrument.instype.id}">
        乐器名：<input type="text" name="name" value="${instrument.name}" placeholder="输入乐器名（必填）"><br>
        类型名：<input type="text" name="instype.name" value="${instrument.instype.name}" placeholder="输入类型名"><br>
