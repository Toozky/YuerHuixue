...
<div class="container">
    <div class="logo">
        <a href="adminindex.jsp">商城后台管理系统</a></div>
    <div class="left_open">
...
<%--            公告管理--%>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('当前管理员信息','adminInfoPage.do')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>当前管理员信息</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('用户管理','adminAndUsersInfoPage.do')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户管理</cite></a>
                    </li>
                    <%--<li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('留言列表','note.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>留言列表</cite></a>
                    </li>
                </ul>
