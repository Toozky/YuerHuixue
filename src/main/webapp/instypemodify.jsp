...
<div class="layui-fluid">
    <div class="layui-row">
        <form class="layui-form" action="instypeModify.do" method="post" enctype="multipart/form-data">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <input type="text" id="name" name="name" value="${instype.name}" placeholder="输入乐器类型名（必填）" required="" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="description" name="description" value="${instype.description}" placeholder="输入描述" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
